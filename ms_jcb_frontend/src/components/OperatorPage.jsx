...
export default function OperatorPage() {
  ...
  return (
    <div className="p-6 space-y-6 dark:bg-gray-900 min-h-screen text-gray-800 dark:text-gray-200">
        ...
        <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
          <thead className="bg-gray-50 dark:bg-gray-700">
            <tr>
              ...
              <th className="px-6 py-3 text-left text-sm font-medium">Salary</th>
          ...
          <tbody className="divide-y divide-gray-100 dark:divide-gray-700">
            {operators.map((op) => (
              <tr key={op.id} className="hover:bg-purple-50 dark:hover:bg-gray-700">
      ...
      {/* No Records Message */}
      {operators.length === 0 && (
        <p className="text-gray-500 dark:text-gray-400 italic">No operators registered yet.</p>
      )}
      ...
      {viewing && (
        <div className="fixed inset-0 z-50 bg-black bg-opacity-40 flex items-center justify-center px-4">
          <div className="relative w-full max-w-lg bg-white dark:bg-gray-900 rounded-xl shadow-xl border border-gray-200 dark:border-gray-700 p-6">
            ...
            {/* Modal Title */}
            <div className="mb-6">
              <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-100">Operator Details</h2>
            ...
            <div className="space-y-4 text-sm">
              {[
                ...
                >
                  ...
                  <span className="text-gray-800 dark:text-gray-100 text-left w-1/2 truncate">{value}</span>
                </div>
              ))}
            </div>
            ...
            <div className="mt-8 text-center">
              <button
                className="px-6 py-2 bg-purple-700 text-white font-semibold rounded-lg hover:bg-purple-800 shadow-sm"
              >
                Edit
              </button>
            </div>
