    ...
    <div className="w-full max-w-xs mx-auto perspective my-4">
      ...
      >
        ...
        <div className="absolute inset-0 bg-white rounded-xl border border-gray-300 p-6 backface-hidden flex flex-col justify-center space-y-3">
          ...
          <p>
            <span className="font-semibold">Age:</span> {operator.age}
          </p>
          <p>
            <span className="font-semibold">Salary:</span> ₹{operator.salary}
          </p>
          <p className="truncate" title={operator.address}>
            <span className="font-semibold">Address:</span> {operator.address}
          </p>
        </div>
